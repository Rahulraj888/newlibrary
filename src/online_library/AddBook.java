...
public class AddBook extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(addbook, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(bookid)
                                .addComponent(title)
                                .addComponent(author)
                                .addComponent(price)
                                .addComponent(noc, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)))
    ...
    private void addbookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbookActionPerformed
        ...
        try
        {
            ...
            int no=Integer.parseInt(noc.getText());
            Connection cn=DataBase.getConnection();
            PreparedStatement ps=cn.prepareStatement("insert into book (id ,title ,author ,price ,no_of_copies) values (?,?,?,?,?)");
            ps.setInt(1, id);
            ps.setString(2,t);
            ps.setString(3, aut);
            ps.setFloat(4, pr);
            ...
            if(a==1)
            {
                JOptionPane.showMessageDialog(AddBook.this, "book added sucessfully");
                cn.commit();
            }
            else
            {
                JOptionPane.showMessageDialog(AddBook.this, "enter correct details");
                cn.rollback();
            }
        }
        catch(Exception e)
